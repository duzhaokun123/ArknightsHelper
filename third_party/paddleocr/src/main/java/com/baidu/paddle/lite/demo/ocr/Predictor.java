...
public class Predictor {
    ...
    private ArrayList<OcrResultModel> resultModels;
    ...
    protected boolean loadModel(Context appCtx, String modelPath, int cpuThreadNum, String cpuPowerMode) {
        ...
        config.detModelFilename = realPath + File.separator + "ch_ppocr_mobile_v2.0_det_slim_opt.nb";
        config.recModelFilename = realPath + File.separator + "ch_ppocr_mobile_v2.0_rec_slim_opt.nb";
        config.clsModelFilename = realPath + File.separator + "ch_ppocr_mobile_v2.0_cls_slim_opt.nb";
        Log.d("Predictor", "model path" + config.detModelFilename + " ; " + config.recModelFilename + ";" + config.clsModelFilename);
    ...
    public ArrayList<OcrResultModel> resultModels() {
        return resultModels;
    }
    ...
    public void drawResults() {
        ArrayList<OcrResultModel> results = resultModels;
    ...
    public String getVersion() {
        if (paddlePredictor == null) return "unknown";
        return paddlePredictor.getVersion();
    }
}
